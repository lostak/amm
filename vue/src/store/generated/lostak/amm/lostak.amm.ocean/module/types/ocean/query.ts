...
const baseQueryGetPoolRequest: object = { index: "" };
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("lostak.amm.ocean.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
  }

  Pool(request: QueryGetPoolRequest): Promise<QueryGetPoolResponse> {
    const data = QueryGetPoolRequest.encode(request).finish();
    const promise = this.rpc.request("lostak.amm.ocean.Query", "Pool", data);
  ...
  PoolAll(request: QueryAllPoolRequest): Promise<QueryAllPoolResponse> {
    ...
    const promise = this.rpc.request("lostak.amm.ocean.Query", "PoolAll", data);
    return promise.then((data) =>
